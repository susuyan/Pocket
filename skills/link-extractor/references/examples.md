...
- Split concerns: MCP standardizes connection, SKILL orchestrates workflow and externalizes state
  ...
  关键词: [MCP][ref1], [Agent Skills][ref2]

[ref1]: https://modelcontextprotocol.io
[ref2]: https://agentskills.io
```
...
- [swift-composable-architecture](https://github.com/pointfreeco/swift-composable-architecture) — Swift 应用架构库,强调组合与可测试性
  ...
  关键词: [Swift][ref1], [TCA][ref2], [组合式架构][ref3]

[ref1]: https://swift.org
[ref2]: https://github.com/pointfreeco/swift-composable-architecture
[ref3]: https://github.com/pointfreeco/swift-composable-architecture/blob/main/README.md
```
